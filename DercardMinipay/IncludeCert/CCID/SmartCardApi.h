#ifndef  _SMARTCARDAPI_H__
#define  _SMARTCARDAPI_H__
...
typedef struct tagSMARTCARD_DEVICE
{
...
SMARTCARD_DEVICE, *PSMARTCARD_DEVICE;
...
extern SMARTCARD_DEVICE g_DevList[MAX_READERS];
